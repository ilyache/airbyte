...
import pytest
from source_jfrog.source import JfrogStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(JfrogStream, "path", "v0/example_endpoint")
    mocker.patch.object(JfrogStream, "primary_key", "test_primary_key")
    mocker.patch.object(JfrogStream, "__abstractmethods__", set())
